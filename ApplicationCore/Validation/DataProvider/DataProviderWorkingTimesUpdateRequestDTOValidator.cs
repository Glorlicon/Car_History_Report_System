...
{
    public class DataProviderWorkingTimesUpdateRequestDTOValidator : AbstractValidator<DataProviderWorkingTimesUpdateRequestDTO>
    {
        public DataProviderWorkingTimesUpdateRequestDTOValidator()
        {
